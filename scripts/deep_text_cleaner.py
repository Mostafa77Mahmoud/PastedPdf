...
يحل مشاكل: التكرار، أرقام الصفحات المكررة، الفهارس، الحواشي المدمجة
"""
...
class DeepTextCleaner:
    ...
    def __init__(self):
        ...
        self.min_line_length = 3  # الحد الأدنى لطول السطر
    ...
    def _remove_short_lines(self, lines: list) -> list:
        """إزالة الأسطر القصيرة جداً (أقل من 3 أحرف)"""
...
def main():
    ...
    print("=" * 70)
    print("🧹 منظف النصوص المتقدم - Deep Text Cleaner")
    print("=" * 70)
    print()
